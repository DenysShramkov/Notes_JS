...
window.addEventListener('DOMContentLoaded', () => {
	...
	//!!!!! важно, при делегировании клик отслеживается на всех элементах родителя, что может привести к багам
	//и ошибкам, вроде ошибочного навешивания класса активности по e.target
	//или если в событие поставить условие по e.target для определения данных, а render вывксти после условия
	//будет ошибочный вызов рендера при клике на родителя мимо целевых элементов
